...
function putToCache(cache, id, err, obj) {
...
exports.putCached = function(cache, id, err, obj, callback) {
    putToCache(cache, id, err, obj);
}
...
exports.exec0 = function(procname, args, options, callback) {
    if( typeof options == 'function' ) {
        callback = options;
        options = null;
    }
    exports.exec1(procname, args, options, false, function(err, output) {
        callback(err);
    });
}
